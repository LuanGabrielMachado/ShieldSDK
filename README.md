...
- security/DilithiumSignatureService.kt: Atualizado de Dilithium3 para Dilithium5, atualizadas as especificações dos parâmetros e a documentação com novas tabelas de tamanho
